...
function install_package() {
    ...
    //обновление
    $core->db->query("UPDATE `{#}controllers` SET `version` = '1.0.0' WHERE `name` = 'zbuilder';");
    $core->db->query("UPDATE `{#}widgets` SET `version` = '1.0.0' WHERE `controller` = 'zbuilder' AND `name` = 'bind';");
